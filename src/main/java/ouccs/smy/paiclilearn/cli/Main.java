...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // [s08 新增] 记忆管理器初始化——通过 hitlRegistry.delegate() 获取项目路径，
        // 展示 HitlToolRegistry 委托模式的正确使用方式
        MemoryManager memoryManager = MemoryManager.createDefault(
                hitlRegistry.delegate().getProjectPath().toString());
